    ...
    <section id="contato" aria-labelledby="contato-title" className="py-20 border-t border-cardBorder/50 flex flex-col items-center">
      ...
      <div className="text-center mb-8 w-full max-w-2xl">
        ...
        <ul className="flex flex-wrap justify-center gap-3" aria-label="Modelos de trabalho disponíveis">
          {disponibilidade.map((modelo) => (
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full bg-secondary" aria-hidden="true"></span>
              {modelo}
            </li>
          ))}
        </ul>
      ...
      <div className="w-full max-w-xl flex flex-col gap-8">
        ...
        <form action="https://formspree.io/f/xeervrjl" method="POST" className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white font-bold py-3 rounded-xl transition-all hover:bg-primary/80 shadow-lg shadow-primary/20 flex items-center justify-center gap-2 mt-2"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-card border border-cardBorder hover:border-primary/50 text-white font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-2"
          >
